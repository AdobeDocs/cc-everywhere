...
- Added support for an all-new Generate Image (Text-to-Image) experience. This feature is disabled by default, displaying the classic interface. To activate it, simply set `enableNewUI` to `true` in [`appConfig`](../../v4/shared/src/types/module/AppConfig.types/interfaces/TextToImageAppConfig.md). Notable enhancements include:
...
- Revised the [Modules](../modules/index.md) and [Quick actions](../quick_actions/index.md) sections to include the latest APIs and features.
