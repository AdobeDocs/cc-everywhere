...
If you wish to create your own curated collection for consumption in the Template Browser, reach out to the Adobe Express Content team. They will be able to help you create the collections and provide you with the respective URNs.
...
3. in the righthand side, opposite to the collection name you'll find a "View all" link; click it.

   <!-- Insert image here -->

4. you'll be redirected to the collection details page.
5. copy the URL of the page, and extract the URN from it; it's the string that starts with `urn`.

   <!-- Insert image here -->

6. this is the URI-encoded URN; in order to use it, you need to decode it using the `decodeURIComponent()` function, for example, in the Browser's console.
...
Or just replace all the `%3A` instances with a `:` in the string. This will return the URN you can use as the `collectionId` in the Template Browser.
