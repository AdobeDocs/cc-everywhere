...
A new tabbed Template Browser is available for authenticated end-users, exposing their **Custom Templates** and **Your Stuff** (Files, Projects, etc.). See [Template Browser v2](./template-browser-v2.md) for the new experience. The v1 surface documented on this page is unchanged.
