...
### INVALID\_AUDIO\_DATA\_URL

```ts
INVALID_AUDIO_DATA_URL: INVALID_AUDIO_DATA_URL = 'INVALID_AUDIO_DATA_URL';
```
...
### INVALID\_ASSISTANT\_APP\_CONFIG

```ts
INVALID_ASSISTANT_APP_CONFIG: INVALID_ASSISTANT_APP_CONFIG = 'INVALID_ASSISTANT_APP_CONFIG';
```

### INVALID\_FDE\_DOC\_CONFIG

```ts
INVALID_FDE_DOC_CONFIG: INVALID_FDE_DOC_CONFIG = 'INVALID_FDE_DOC_CONFIG';
```
...
### IMS\_USER\_ACTION\_REQUIRED

```ts
IMS_USER_ACTION_REQUIRED: IMS_USER_ACTION_REQUIRED = 'IMS_USER_ACTION_REQUIRED';
```
...
### PROMPT\_SAFETY\_CHECK\_TIMED\_OUT

```ts
PROMPT_SAFETY_CHECK_TIMED_OUT: PROMPT_SAFETY_CHECK_TIMED_OUT = 'PROMPT_SAFETY_CHECK_TIMED_OUT';
```
...
### WORKFLOW\_CONTEXT\_UPDATE\_ERROR

```ts
WORKFLOW_CONTEXT_UPDATE_ERROR: WORKFLOW_CONTEXT_UPDATE_ERROR = 'WORKFLOW_CONTEXT_UPDATE_ERROR';
```

### WORKFLOW\_CONTEXT\_ERROR

```ts
WORKFLOW_CONTEXT_ERROR: WORKFLOW_CONTEXT_ERROR = 'WORKFLOW_CONTEXT_ERROR';
```

### WORKFLOW\_CONTEXT\_TIMEOUT

```ts
WORKFLOW_CONTEXT_TIMEOUT: WORKFLOW_CONTEXT_TIMEOUT = 'WORKFLOW_CONTEXT_TIMEOUT';
```
