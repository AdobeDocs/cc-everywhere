...
| ------ | ------ | ------ |
| <a id="type"></a> `type` | [`URL_INFO`](../../message-data-types/enumerations/host-event-type.md#url_info) | [`HostEventData`](../../message-data-types/interfaces/host-event-data.md).[`type`](../../message-data-types/interfaces/host-event-data.md#type) |
