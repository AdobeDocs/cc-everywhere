...
| ------ | ------ | ------ |
| `type` | [`INTENT_CHANGED`](../enumerations/host-event-type.md#enumeration-member-intent_changed) | [`HostEventData`](host-event-data.md).[`type`](host-event-data.md#property-type) |
