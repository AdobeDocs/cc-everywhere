...
| ------ | ------ | ------ |
| `type` | [`EXPORT_INFO`](../enumerations/host-event-type.md#enumeration-member-export_info) | [`HostEventData`](host-event-data.md).[`type`](host-event-data.md#property-type) |
