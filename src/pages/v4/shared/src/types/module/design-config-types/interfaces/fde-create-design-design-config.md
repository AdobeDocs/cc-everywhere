...
# Interface: FDECreateDesignDesignConfig
...
| `appConfig?` | \| `FDECreateDesignAppConfig` \| [`FDECreateDesignAppConfig`](../../../3p/module/app-config-types/interfaces/fde-create-design-app-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`appConfig`](../../../design-config-types/interfaces/design-config.md#property-appconfig) | - |
