...
| `appConfig?` | [`StartFromContentAppConfig`](../../app-config-types/interfaces/start-from-content-app-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`appConfig`](../../../design-config-types/interfaces/design-config.md#property-appconfig) | - |
