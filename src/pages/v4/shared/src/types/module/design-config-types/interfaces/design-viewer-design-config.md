...
| `docConfig?` | [`DesignViewerDocConfig`](../../doc-config-types/interfaces/design-viewer-doc-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`docConfig`](../../../design-config-types/interfaces/design-config.md#property-docconfig) | - |
| `appConfig?` | [`DesignViewerAppConfig`](../../app-config-types/interfaces/design-viewer-app-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`appConfig`](../../../design-config-types/interfaces/design-config.md#property-appconfig) | - |
