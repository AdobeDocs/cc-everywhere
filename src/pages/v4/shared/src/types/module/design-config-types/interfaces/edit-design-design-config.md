...
# Interface: EditDesignDesignConfig
...
| `docConfig?` | [`EditDesignDocConfig`](../../doc-config-types/interfaces/edit-design-doc-config.md) | - | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`docConfig`](../../../design-config-types/interfaces/design-config.md#docconfig) | - |
| `appConfig?` | `EditDesignAppConfig` | App configuration for the Edit Design experience. **See** FirstParty.Module.EditDesignAppConfig | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`appConfig`](../../../design-config-types/interfaces/design-config.md#appconfig) | - |
