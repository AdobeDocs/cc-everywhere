...
| `appConfig?` | [`TextToImageAppConfig`](../../app-config-types/interfaces/text-to-image-app-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).`appConfig` | - |
