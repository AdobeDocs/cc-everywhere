...
| `appConfig?` | [`TextToImageAppConfig`](../../AppConfig.types/interfaces/text-to-image-app-config/index.md.md) | [`DesignConfig`](../../../DesignConfig.types/interfaces/design-config/index.md).`appConfig` | - |
