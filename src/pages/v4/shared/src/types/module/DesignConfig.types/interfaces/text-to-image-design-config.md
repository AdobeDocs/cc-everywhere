...
| `appConfig?` | [`TextToImageAppConfig`](../../AppConfig.types/interfaces/TextToImageapp-config.md) | [`DesignConfig`](../../../DesignConfig.types/interfaces/design-config.md).`appConfig` | - |
