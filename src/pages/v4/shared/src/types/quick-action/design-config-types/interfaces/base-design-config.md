...
| `appConfig?` | [`AppConfig`](../../app-config-types/interfaces/app-config.md) | [`DesignConfig`](../../../design-config-types/interfaces/design-config.md).[`appConfig`](../../../design-config-types/interfaces/design-config.md#property-appconfig) | - |
