...
| `colorTheme?` | [`ColorTheme`](../../../app-config-types/enumerations/color-theme.md) | Theming options for the Quick Action Editor **Default** `ColorTheme.LIGHT` | [`ColorThemeAppConfig`](../../../design-config-types/interfaces/color-theme-app-config.md).[`colorTheme`](../../../design-config-types/interfaces/color-theme-app-config.md#colortheme) | - |
