...
| `showExpressIconWithoutText?` | `readonly` | `boolean` | Show new express icon without text | [`InlineOrModalContainerConfig`](../../container-config-types/interfaces/inline-or-modal-container-config.md).[`showExpressIconWithoutText`](../../container-config-types/interfaces/inline-or-modal-container-config.md#showexpressiconwithouttext) |
