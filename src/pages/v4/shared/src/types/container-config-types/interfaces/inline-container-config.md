...
| `showExpressIconWithoutText?` | `readonly` | `boolean` | Show new express icon without text | [`InlineOrModalContainerConfig`](inline-or-modal-container-config.md).[`showExpressIconWithoutText`](inline-or-modal-container-config.md#showexpressiconwithouttext) |
