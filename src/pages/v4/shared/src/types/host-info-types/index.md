...
| ------ | ------ |
| [ConfigParams](type-aliases/config-params.md) | Config params for 1P and 3P. It is a union of ConfigParams1P and [ConfigParams3P](../3p/host-info-types/interfaces/config-params.md). |
