...
| `docConfig?` | \| [`TargetDocConfig`](..\..\..\design-config-types\interfaces\target-doc-config.md) \| [`CreateDocConfig`](..\..\doc-config-types\interfaces\create-doc-config.md) | `EditorDesignConfig.docConfig` | - |
