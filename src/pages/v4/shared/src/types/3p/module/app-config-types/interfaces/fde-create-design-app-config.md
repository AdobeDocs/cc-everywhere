...
| `contentBrowseConfig?` | [`BrowseModeConfig`](../../../../module/app-config-types/interfaces/browse-mode-config.md) | - | [`FDECreateDesignAppConfig`](../../../../module/app-config-types/interfaces/fde-create-design-app-config.md).[`contentBrowseConfig`](../../../../module/app-config-types/interfaces/fde-create-design-app-config.md#property-contentbrowseconfig) |
