...
| `inlineTOUConsent?` | `boolean` | Property to configure whether inline Terms Of User consent will be displayed | [`EditImageAppConfig`](../../../../module/app-config-types/interfaces/edit-image-app-config.md).[`inlineTOUConsent`](../../../../module/app-config-types/interfaces/edit-image-app-config.md#property-inlinetouconsent) |
| `desktopFocusedMode?` | `boolean` | Enables the desktop focused-mode experience for Edit Image. **Default** `false` | [`EditImageAppConfig`](../../../../module/app-config-types/interfaces/edit-image-app-config.md).[`desktopFocusedMode`](../../../../module/app-config-types/interfaces/edit-image-app-config.md#property-desktopfocusedmode) |
| `desktopAssistantMode?` | `boolean` | Enables the beta version of AI assistant prompt bar in the Edit Image QA experience. **Default** `false` | [`EditImageAppConfig`](../../../../module/app-config-types/interfaces/edit-image-app-config.md).[`desktopAssistantMode`](../../../../module/app-config-types/interfaces/edit-image-app-config.md#property-desktopassistantmode) |
