...
| `outputType?` | [`AssetDataType`](../../asset-types/enumerations/asset-data-type.md) | Desired asset data type for the generated preview, independent of primary asset's [PublishAction.outputType](publish-action.md#property-outputtype). **Default** `base64` |
