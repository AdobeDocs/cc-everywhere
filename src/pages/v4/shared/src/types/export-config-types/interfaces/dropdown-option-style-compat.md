...
| `variant?` | [`ExportButtonVariant`](..\type-aliases\export-button-variant.md) | The variant for the button. | - |
| `treatment?` | [`ExportButtonTreatment`](..\type-aliases\export-button-treatment.md) | The treatment for the button. | - |
