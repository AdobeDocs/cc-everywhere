...
const GetCredentialApiKey = () => {
  ...
  return (
    <GetCredential className="getCredentialContainer" templateId={template_id} productName={product_name} >
      ...
      <GetCredential.Return title="Previously created projects" paragraph="Select a project and access your existing credentials for Adobe Express Embed SDK." nextStepsLabel="Next steps" nextStepsHref={"https://developer.adobe.com/express/embed-sdk/docs/guides/quickstart/"} className="card_developer_console">
